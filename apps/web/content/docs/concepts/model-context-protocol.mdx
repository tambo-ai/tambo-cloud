...
<LearnMore
  ...
  description="Learn how to connect to MCP servers with different configurations"
  href="/docs/concept-details/model-context-protocol/clientside-mcp-connection"
/>
