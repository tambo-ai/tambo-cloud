...
<LearnMore
  title="More about streaming"
  description="Learn how to show components as their props stream in"
  href="/docs/concept-details/streaming/response-text-streaming"
/>
