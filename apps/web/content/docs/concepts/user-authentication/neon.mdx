...
## Why Use Neon with Auth.js?

### Database Integration

- **Persistent Sessions**: Store user sessions, accounts, and verification tokens in your Neon database
- **User Management**: Centralize user data alongside your application data
- **Scalability**: Leverage Neon's serverless PostgreSQL for automatic scaling

### Development Benefits

- **Unified Data Layer**: Keep authentication data in the same database as your application data
- **Advanced Queries**: Use SQL to analyze user behavior and authentication patterns
- **Backup & Recovery**: Benefit from Neon's backup and point-in-time recovery features

<Callout type="info" title="Database Tables">
  The Neon adapter automatically creates the necessary tables for Auth.js
  (users, accounts, sessions, verification_tokens) in your Neon database when
