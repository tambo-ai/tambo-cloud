...
"use client";
// TamboProvider must be used in a client component
...
<Cards>
  <Card
    href="/docs/concepts/user-authentication/nextauth"
    title="NextAuth Integration"
  >
    Learn how to integrate Tambo with NextAuth using Google OAuth as an example.
  </Card>
  <Card
    href="/docs/concepts/user-authentication/auth0"
    title="Auth0 Integration"
  >
    Step-by-step guide for integrating Tambo with Auth0 authentication.
  </Card>
  <Card
    href="/docs/concepts/user-authentication/clerk"
    title="Clerk Integration"
  >
    Complete example of using Tambo with Clerk's authentication system.
  </Card>
  <Card
    href="/docs/concepts/user-authentication/supabase"
    title="Supabase Integration"
  >
    Integration guide for Supabase Auth with Tambo in Next.js applications.
  </Card>
  <Card href="/docs/concepts/user-authentication/neon" title="Neon Integration">
    How to use Tambo with Neon Auth and PostgreSQL database integration.
  </Card>
  <Card
    href="/docs/concepts/user-authentication/workos"
