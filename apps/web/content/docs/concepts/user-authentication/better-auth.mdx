...
Better Auth provides several built-in features that work well with Tambo:
...
- **Plugin System**: Easy to extend with features like 2FA, magic links, passkeys
- **Session Management**: Automatic session handling and token refresh
- **Server-Side Rendering**: Full support for Next.js App Router

The session token from Better Auth can be used directly with Tambo's authentication system, providing a seamless integration experience.
