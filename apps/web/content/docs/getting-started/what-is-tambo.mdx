...
<LearnMore
  ...
  description="Learn how the React package is used in an application"
  href="/docs/concepts/components/"
/>

## Tambo API

The API processes user messages, generates AI responses, manages conversation threads, orchestrates tool calls, and handles user authentication.
