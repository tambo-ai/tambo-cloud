---
title: Registering Components as UI Tools
description: Learn how to register components as UI Tools with Tambo.
---
...
// Define a Zod schema for the weather data passed as props to the component
