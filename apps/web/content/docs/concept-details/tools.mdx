...
Tambo uses existing LLM tool calling capabilities to call your tools. For more
details see the tool documentation at
...
<Cards>
  <Card
    ...
    href="/docs/concepts/model-context-protocol"
  >
    Tambo also supports MCP, which is a standard way to extend the AI's
