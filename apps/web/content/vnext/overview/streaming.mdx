...
When a request is made with `streamResponse: true`, currently tambo will update the response message's `renderedComponent` field as soon as the component is chosen, even before all the props have been generated.
