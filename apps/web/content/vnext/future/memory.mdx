...
<Callout type="info" title="API Key Required">
  You'll need a Tambo API key to use the memory features. If you don't already have an account, <a href="/dashboard" className="text-primary hover:underline font-medium">sign up for free</a> to get your API key.
</Callout>
