...
description: Our planned features and milestones on the path to tambo 1.0.
---

# Roadmap to 1.0

After our initial release of tambo 0.1.0, we have an exciting roadmap of features planned for our journey to 1.0! Here's what we're working on:
