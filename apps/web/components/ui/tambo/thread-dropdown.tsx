...
export interface ThreadDropdownProps
  ...
  onThreadChange?: () => void;
  /** Optional className for the trigger button specifically */
  triggerClassName?: string;
  /** Optional className for the dropdown content specifically */
  contentClassName?: string;
  /** Optional className for menu items */
 ...
 *   triggerClassName="custom-trigger-styles"
 *   contentClassName="custom-content-styles"
 *   itemClassName="custom-item-styles"
 * />
 * ```
 */
...
>(
  (
    ...
    const handleSwitchThread = async (
      threadId: string,
      e?: React.MouseEvent,
    ) => {
      if (e) {
