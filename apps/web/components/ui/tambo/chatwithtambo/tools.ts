  ...
  useEffect(() => {
    ...
    registerTool({
      ...
      tool: async (params: {
        ...
        return await trpcClient.project.updateProject.mutate({
    ...
    registerTool({
      ...
      tool: async (projectName: string) => {
        return await trpcClient.project.createProject.mutate(projectName);
      },
    ...
    registerTool({
      ...
      tool: async (projectId: string, name: string) => {
        return await trpcClient.project.generateApiKey.mutate({
          projectId,
          name,
        });
      },
    ...
    registerTool({
      ...
      tool: async (
        ...
        return await trpcClient.project.updateProjectLlmSettings.mutate({
          projectId: projectId,
    ...
    registerTool({
      ...
      tool: async (
        ...
        return await trpcClient.tools.addMcpServer.mutate({
          projectId,
          url: server.url,
    ...
    /**
     * Registers a tool to update an existing MCP server configuration.
     ...
     * @param {string} params.url - The updated URL of the MCP server
     * @param {Record<string, string>} params.customHeaders - Updated custom HTTP headers
     * @param {MCPTransport} params.mcpTransport - Updated transport mechanism
    ...
    registerTool({
      ...
      tool: async (params: {
        ...
        return await trpcClient.tools.updateMcpServer.mutate({
          projectId: params.projectId,
