...
date: "2025-09-04"
description: "Learn how to build an AI assistant with React components and MCPs. Step-by-step guide to integrating interactive UI elements into AI chat experiences."
...
<BlogPost title="We gave our AI assistant access to our React Components and MCP Server" author="Akhilesh Rangani" date="2025-09-04">
...
We figured: if we already have React components and APIs to perform these tasks, the assistant should be able to **render and interact with them directly**.

Now you can just ask for what you want and it will search your data, render the UI to perform sensitive actions, and explain how the app works.
...
1. **Wrapped our existing React components in schemas**. This gave tambo a contract for what props each component needed and what they did.
...
By the way our repo is [open source](https://github.com/tambo-ai/tambo-cloud), so you can see the code for yourself.
...
Example: Registering the [APIKeyList component](https://github.com/tambo-ai/tambo-cloud/blob/main/apps/web/components/ui/tambo/chatwithtambo/config.ts#L62).
