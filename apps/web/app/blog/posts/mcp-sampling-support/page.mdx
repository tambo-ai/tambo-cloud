...
sequenceDiagram
    ...
    T->>M: What's the weather in San Francisco?
    M->>L: Summarize this weather data: 68°F, partly cloudy, 15mph winds, SF
...
sequenceDiagram
    ...
    U->>T: What's the weather in San Francisco?
    T->>M: What's the weather in San Francisco?
    M->>T: Summarize this weather data: 68°F, partly cloudy, 15mph winds, SF
