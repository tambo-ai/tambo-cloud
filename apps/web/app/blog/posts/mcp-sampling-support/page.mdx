...
sequenceDiagram
    ...
    U->>S: What's the weather in San Francisco?
    S->>D: Fetch weather data for city: "San Francisco"
    D-->>S: Return raw data: 68°F, partly cloudy, 15mph winds
    S->>L: Summarize this weather data: 68°F, partly cloudy, 15mph winds, SF
    L-->>S: It's 68°F and partly cloudy in San Francisco.
    S-->>U: "It's 68°F and partly cloudy in San Francisco."
...
sequenceDiagram
    ...
    participant S as Weather MCP Server
    participant D as Data Source
    participant L as Client's LLM (Tambo)
