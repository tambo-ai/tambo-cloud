...
> How to use the CLI to get your API key? [→](/docs/troubleshooting/cli)
...
```typescript title="src/mainComponent.tsx"
"use client";
...
```typescript title="types/hydra.d.ts"
import { z } from "zod";
...
```typescript title="src/components/HydraErrorBoundary.tsx"
