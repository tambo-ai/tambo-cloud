...
1. **Create and install Slack app**
    ...
    Follow instructions here to install the app in your Slack workspace: [Slack app setup instructions](https://github.com/slack-samples/bolt-ts-starter-template?tab=readme-ov-file#create-a-slack-app)
