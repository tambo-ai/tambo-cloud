...
In this step, we'll install Hydra and add a message listener that sends messages to Hydra AI and responds to the user with Hydra's output.
...
## Add Hydra AI message listener
    ...
    1. **Add Hydra AI message handler file**
        ...
        Add a new file called `hydra-message.ts` under `src/listeners/messages` directory.
