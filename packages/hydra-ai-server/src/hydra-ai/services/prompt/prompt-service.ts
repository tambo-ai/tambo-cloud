...
Finally, if you decide that a component should be generated, you will output the name of the component between <component></component> tags.`;
    ...
    generateNoComponentPrompt(reasoning: string, availableComponents: AvailableComponents): string {
...
${this.generateZodTypePrompt(schema)}`;
    ...
    generateAvailableComponentsPrompt(availableComponents: AvailableComponents): string {
        return `
